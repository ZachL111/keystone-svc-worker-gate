"""Regression checks for the keystone-svc-worker-gate casebook."""
...
from casebook.harness import assert_expected, keystone_svc_worker_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(keystone_svc_worker_gate_summary(), assert_expected())
